...
| TM-03 | Session theft/fixation/replay or weak recovery                 | Medium / High            | CSPRNG opaque session tokens, DB hashes, HttpOnly/Lax/Secure, expiry/revocation; login creates a new token; recovery/verification token records exist without a delivery route. Prompt 57 resolves the invitation page session server-side, uses a fixed safe sign-in return path, and discards the pasted token rather than carrying it through reauthentication.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Public recovery route, delivery adapter and revoke-all-on-password-change remain later work                                                                                                                                                                                       | Phase 5/mail        |
