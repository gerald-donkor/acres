...
| `docs/launch-checklist.md` | the Phase 12K exit-gate checklist — unified drill orchestrator and evidence dossier, 11-category sign-off matrix, 7 Prometheus alert runbooks, rollback/DR procedures | **written.** Read before running `ops:launch-drill`, approving launch, or editing alert runbooks |
